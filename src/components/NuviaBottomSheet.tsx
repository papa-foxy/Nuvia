...
export function NuviaBottomSheet({
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 pb-[calc(56px+env(safe-area-inset-bottom,0px))] sm:pb-0"
    >
      {/* Backdrop: covers page background above bottom nav on mobile, full on sm */}
      <div
      ...
      <div
        ...
        className={`relative w-full ${maxWidth} bg-[#161618] border border-white/10 rounded-t-[28px] sm:rounded-[28px] max-h-[calc(100dvh-56px-env(safe-area-inset-bottom,0px)-0.75rem)] sm:max-h-[85vh] flex flex-col overflow-hidden shadow-2xl z-10 will-change-transform`}
      >
        {/* Grab Handle */}
        {showGrabHandle && (
          <div
